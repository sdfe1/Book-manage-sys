...
public class CategoryServiceImpl implements CategoryService {
    ...
    public void deleteCategory(int id) {
        // 防御性校验
        if ( id <= 0) {
            throw new CategoryErrorException(CommonErrorCodeEnum.INVALID_REQUEST, "ID必须为正整数");
        }
    ...
    public void updateCategory(CategoryDTO categoryDTO) {
        ...
        if (rows == 0) {
            throw new CategoryErrorException(CommonErrorCodeEnum.CONCURRENT_CONFLICT,"数据已被修改，请刷新后重试");
        }
    }
